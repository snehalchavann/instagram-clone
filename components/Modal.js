...
function Modal() {
    ...
    // Upload a picture to firebase database
    ...
    return <Transition.Root show={open} as={Fragment}>
        {/* dialog is what actually we see on screen */}
        <Dialog as="div"
        ...
        onClose={setOpen}>
            ...
            sm:block sm:p-0">
                ...
                leaveTo="opacity-0">
                    ...
                    {/* responsible for actually showing content */}
                        ...
                        overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            ...
                            <div>
                                ...
                                <div className="mt-5 sm:mt-6">
                                    <button onClick={uploadPost} disabled={!selectedFile} type="button"
